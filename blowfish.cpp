...
int main()
{
    ...
    Blowfish bf;
    bf.SetKey(key, sizeof(key) - 1);

    unsigned char plaintext[16] = "There's nothing";
    unsigned char ciphertext[16];
    unsigned char decrypted[16];

    bf.Encrypt(ciphertext, plaintext, sizeof(plaintext));
    ...
    bf.Decrypt(decrypted, ciphertext, sizeof(ciphertext));
